...
# Creating dictionary to hold information within one line so its easier to read   
    all_results = {}
...
def start_end(start, end):
    ...
    # USE return jsonify(f"Min:{results[0]}, Max:{results[1]}, Avg:{results[2]}") For Cleaner looking results
